            ...
            <div class="card-body">
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="<?= htmlspecialchars($receiver->name) ?>"
                            class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Phone</label>
                        <input type="number" name="phone" value="<?= htmlspecialchars($receiver->phone) ?>"
                            class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Kota</label>
                        <input type="text" name="city" value="<?= htmlspecialchars($receiver->city) ?>"
                            class="form-control" required>
                    </div>
