...
$html = '
<h2 style="text-align:center">Laporan Pengiriman Mingguan</h2>
...
$dompdf->setPaper('A4', 'landscape'); // landscape lebih cocok untuk laporan mingguan
$dompdf->render();
$dompdf->stream("Laporan_Pengiriman_Mingguan_{$start}_to_{$end}.pdf", array("Attachment" => false));
